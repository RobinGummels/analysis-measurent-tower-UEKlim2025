...
text(x = 144, y = 0.9, labels = "24h", col = "red", pos = 3, cex = 1.2, font = 2)
text(x = 288, y = 0.9, labels = "48h", col = "red", pos = 3, cex = 1.2, font = 2)
text(x = 432, y = 0.9, labels = "72h", col = "red", pos = 3, cex = 1.2, font = 2)
```
...
## Saisonale Komponente (Tagesverlauf) rausrechnen
Um die Temperaturänderung ohne des Tagesverlauf zu erkennen, können wir diese statisch "herausrechnen":
```{r}
