...
## Zusammenfassung: Temperatur und relative Luftfeuchtigkeit {.smaller}

::: {.columns}

::: {.column width="50%"}
### Temperatur (18.11. - 09.12.2025)

- **Bereich:** ~0°C bis ~12°C
- **November:** Durchschnitt ca. 4°C
- **Dezember:** Etwas wärmer, Durchschnitt ca. 7°C
- **Tagesgang:** Deutliche Amplitude (2-6°C), besonders an klaren Tagen
:::
...
- **Bereich:** ~60% bis ~100%
- **Typisch:** durchschnitt 90% im November/Dezember
- **Verhalten:** Stark antiproportional zur Temperatur
- **Tagsüber:** Niedrigere Werte 
- **Nachts:** Oft 100% 
:::
...
## Zusammenfassung: Absolute vs. Relative Luftfeuchtigkeit {.smaller}

::: {.incremental}
### Was zeigen die Daten?

- **Relative Luftfeuchtigkeit:** Schwankt stark zwischen ~60% und 100%, oft invers zur Temperatur
- **Absolute Luftfeuchtigkeit:** Bewegt sich stabiler im Bereich von ~0.005–0.009 kg·m⁻³

### Warum verhalten sich beide unterschiedlich?

- Die **relative Feuchte** hängt von der Sättigungskapazität der Luft ab → steigt die Temperatur, sinkt die relative Feuchte (bei gleichem Wassergehalt)
- Die **absolute Feuchte** zeigt den tatsächlichen Wasserdampfgehalt → ändert sich nur bei Verdunstung, Kondensation oder Luftmassenwechsel
:::

## Erkenntnisse aus den Messdaten {.smaller}
...
- Tagsüber (wärmer): Relative Feuchte sinkt, absolute bleibt stabil
- Nachts (kälter): Relative Feuchte steigt oft auf ~100% (Taupunkt erreicht)
- Absolute Feuchte zeigt Änderungen bei Wetterwechsel (neue Luftmassen)
:::

::: {.column width="50%"}
**Interpretation:**

- Hohe relative Feuchte bedeutet **nicht** automatisch viel Wasser in der Luft
- Im November/Dezember: Kalte Luft kann weniger Wasser halten → schnell 100% erreicht
- Absolute Feuchte eignet sich besser zum Vergleich verschiedener Tage/Temperaturen
:::
...
Die Unterscheidung ist wichtig für: Nebel-/Taubildung und Verdunstungsraten
...
## Zusammenfassung: Tagesverlauf und Trends {.smaller style="font-size: 0.75em;"}
...
**Problem:** Tägliche Temperaturzyklen überdecken längerfristige Trends

**Lösung:** Tagesverlauf als Sinusfunktion modelliert und herausgerechnet

**Ergebnis:** Bereinigte Daten zeigen Abweichungen vom typischen Muster
:::

::: {.column width="50%"}
### Warum ist das wichtig?

- **Autokorrelation:** Temperatur wiederholt sich alle 24h (Sonnenzyklus)
- **Bereinigung:** Entfernt Wiederholungen, macht langfristige Muster sichtbar
- **Praktisch:** Erkennung ungewöhnlicher Tage unabhängig von der Tageszeit

**Kurz gesagt:** Wir filtern das „Normale" heraus, um das „Besondere" zu sehen.
:::
